...
app.on('request', async (req, res) => {
  ...
  try {
    // Search colleges
    if (req.method === 'GET' && parsedUrl.pathname === '/api/search-colleges') {
    ...
    // Submit request
    if (req.method === 'POST' && parsedUrl.pathname === '/api/submit-request') {
    ...
    if (req.method === 'GET' && parsedUrl.pathname === '/api/requests') {
